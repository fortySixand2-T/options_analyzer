...
Usage:
    python -m src.chain_scanner.cli --tickers AAPL,MSFT,NVDA --top 10
    python -m src.chain_scanner.cli --tickers AAPL --min_dte 20 --max_dte 60
    python -m src.chain_scanner.cli --watchlist config/watchlist.json --top 20
    python -m src.chain_scanner.cli --tickers AAPL --export scanner_results.csv
...
from chain_scanner import OptionSignal, scan_watchlist
from chain_scanner.providers import create_provider
